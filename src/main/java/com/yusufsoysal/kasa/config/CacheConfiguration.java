package com.yusufsoysal.kasa.config;
...
public class CacheConfiguration {
    ...
    public HazelcastInstance hazelcastInstance(JHipsterProperties jHipsterProperties) {
        ...
        HazelcastInstance hazelCastInstance = Hazelcast.getHazelcastInstanceByName("kasa");
        if (hazelCastInstance != null) {
            log.debug("Hazelcast already initialized");
            return hazelCastInstance;
        }
        Config config = new Config();
        config.setInstanceName("kasa");
        ...
        config.getMapConfigs().put("com.yusufsoysal.kasa.domain.*", initializeDomainMapConfig(jHipsterProperties));
