package com.yusufsoysal.kasa;

import com.yusufsoysal.kasa.config.ApplicationProperties;
import com.yusufsoysal.kasa.config.DefaultProfileUtil;
...
public class KasaApp {
    ...
    private static final Logger log = LoggerFactory.getLogger(KasaApp.class);

    private final Environment env;

    public KasaApp(Environment env) {
        this.env = env;
    }
    ...
    public static void main(String[] args) throws UnknownHostException {
        SpringApplication app = new SpringApplication(KasaApp.class);
